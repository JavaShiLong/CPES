 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" action="${APP_PATH}/member/startProcess.do" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="exampleInputEmail1">邮箱地址</label>
			<input type="text" class="form-control" id="femail" name="email" value="${member.email}" placeholder="请输入真实名称">
		  </div>
	    	...
	    	$("#applyForm").ajaxSubmit({
	    		...
	    		success : function( r ) {
	    			...
	    			if ( r.success ) {
	    	    		...
	    	    		layer.msg("流程申请失败，无法继续操作", {time:1500, icon:5, shift:6});
	    			}
	    		}
	    	});
        });
