 ...
 <hr style="clear:both;">
            ...
            <table id="certTable" class="table  table-bordered">
              ...
              <tbody>
                  <#list certs as cert>
	                <tr >
	                  <th>${cert.name}</th>
					  <th ><input type="checkbox" data-accttype="0" data-certid="${cert.id}"></th>
	                  <th><input type="checkbox"  data-accttype="1" data-certid="${cert.id}"></th>
	                  <th><input type="checkbox"  data-accttype="2" data-certid="${cert.id}"> </th>
	                  <th><input type="checkbox"  data-accttype="3" data-certid="${cert.id}"> </th>
	                </tr>
                  </#list>
              </tbody>
            </table>
	...
	<script src="${APP_PATH}/jquery/jquery-form.min.js"></script>
        <script type="text/javascript">
            ...
            var box = $("#certTable :checkbox[data-accttype='${acctCert.accttype}'][data-certid='${acctCert.certid}']");
            box[0].checked = true;
            </#list>
