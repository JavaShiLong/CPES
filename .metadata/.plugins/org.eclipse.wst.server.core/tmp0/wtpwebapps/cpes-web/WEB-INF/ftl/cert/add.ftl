        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form action="${APP_PATH}/cert/insertCert.do" method="post" id="certForm" cert="form">
				  <div class="form-group">
					<label for="exampleInputEmail1">资质名称</label>
					<input type="text" class="form-control" id="fname" name="name" placeholder="请输入资质名称">
				  </div>
			    	...
			    	$("#certForm").ajaxSubmit({
			    		...
			    		success : function( r ) {
			    			...
			    			if ( r.success ) {
			    	    		...
			    	    		layer.msg("增加资质信息失败", {time:1000, icon:5, shift:6});
			    			}
			    		}
			    	});
			    });
