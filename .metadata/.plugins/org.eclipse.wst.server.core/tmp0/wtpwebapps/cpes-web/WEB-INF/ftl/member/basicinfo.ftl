 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" action="${APP_PATH}/member/updateMemberBasicInfo.do" role="form" style="margin-top:20px;">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="fcardno" name="cardno" placeholder="请输入身份证号码">
		  </div>
		  <div class="form-group">
	    	...
	    	$("#applyForm").ajaxSubmit({
	    		...
	    		success : function( r ) {
	    			...
	    			if ( r.success ) {
	    	    		...
	    	    		layer.msg("基本信息更新失败，无法继续操作", {time:1500, icon:5, shift:6});
	    			}
	    		}
	    	});
        });
