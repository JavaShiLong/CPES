 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" enctype="multipart/form-data" action="${APP_PATH}/member/uploadCertFile.do" role="form" style="margin-top:20px;">
		  <#list certs as cert>
	    	...
	    	$("#applyForm").ajaxSubmit({
	    		...
	    		success : function( r ) {
	    			...
	    			if ( r.success ) {
	    	    		...
	    	    		layer.msg("资质文件上传失败，无法继续操作", {time:1500, icon:5, shift:6});
	    			}
	    		}
	    	});
        });
