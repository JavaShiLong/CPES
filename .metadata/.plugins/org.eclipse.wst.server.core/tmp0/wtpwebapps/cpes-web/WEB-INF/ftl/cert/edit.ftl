        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form action="${APP_PATH}/cert/updateCert.do" method="post" id="certForm" cert="form">
				  <input type="hidden" name="id" value="${cert.id}">
				  <div class="form-group">
					<label for="exampleInputEmail1">资质名称</label>
					<input type="text" class="form-control" value="${cert.name}" id="fname" name="name" placeholder="请输入资质名称">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	var fname = $("#fname");
			    	if ( fname.val() == "" ) {
			    		layer.msg("资质名称不能为空，请输入", {time:1000, icon:5, shift:6}, function(){
			    			fname.focus();
			    		});
			    		return;
			    	}
			    	...
			    	$("#certForm").ajaxSubmit({
			    		...
			    		success : function( r ) {
			    			...
			    			if ( r.success ) {
			    	    		...
			    	    		layer.msg("修改资质信息失败", {time:1000, icon:5, shift:6});
			    			}
			    		}
			    	});
			    });
