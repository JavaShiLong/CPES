	...
	<script src="${APP_PATH }/ztree/jquery.ztree.all-3.5.min.js"></script>
        <script type="text/javascript">
			...
			$("#assignBtn").click(function(){
				...
				$.ajax({
					url : "${APP_PATH}/role/assign.do",
					type : "POST",
					data : dataObj,
					success : function(result){
						if(result.success){
							layer.msg("许可分配成功", {time : 1000,icon : 6,shift : 6});
						}else{
							layer.msg("许可分配失败", {time : 1000,icon : 5,shift : 6});
						}
					}
				}); 
